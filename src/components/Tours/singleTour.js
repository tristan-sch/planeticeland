...
const TourImage = styled.div((props) => [
...
const ControlButton = styled(PrimaryButton)`
  ${tw`mx-3 rounded-full text-gray-100 p-2 bg-secondary-dark hover:bg-primary-dark`}
`;
...
const Description = tw.p`max-w-md text-center mx-auto lg:mx-0 lg:text-left lg:max-w-none leading-relaxed text-sm sm:text-base lg:text-lg font-medium mt-4`;
...
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-primary-dark`;
              ...
              >
                {testimonials.map((testimonial, index) => (
                  <ImageAndControlContainer key={index}>
                    <TourImage imageSrc={testimonial.imageSrc} />
                    <ControlContainer>
