...
const Card = tw.a`flex flex-col items-center text-center h-full mx-4 px-6 py-8 rounded transition-transform duration-300 hover:cursor-pointer transform hover:scale-105`;
...
const SubDescription = tw.div`mt-4 mx-4 text-base font-medium font-primary`;
